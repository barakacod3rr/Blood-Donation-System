...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
  ...
  <header class="top-header">
    <nav class="navbar header-nav navbar-expand-lg">
            <div class="container">
        <a href="index.html"><p style="font-size: 30px; color: red;">RED LIVES</p></a>
...
<div class="row">
        <div class="col-lg-12">
          <div class="title-box">
            <h2>New Password</h2>
            <p>Kindly Set Your New Password Below.</p>
          </div>
        </div>
      </div>
      <div class="row">
          ...
          <form method="POST" action="insertnewpass.php">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <input type="password" class="form-control" id="password" name="pass" placeholder="Your Password..." required>
                <input type="checkbox" onclick="myFunction()">Show Password
              </div>                                 
            </div>
             <div class="col-md-6">
              <div class="form-group">
                <input type="password" class="form-control" id="password1" name="passc" placeholder="Verify Password..." required>
