                               <!--RECOVERING PASSWORD FOR ADMINISTRATORS-->
<!DOCTYPE html>
<html lang="en"><!-- Basic -->
<head>
  <meta charset="utf-8">
          ...
          <div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background-image:url(images/slider-02.jpg);">
            <div class="lbox-caption pogoSlider-slide-element">
              <div class="lbox-details">
                ...
                <p>Our system has the ability to keep blood donor and patient records.</p>
...
<div class="row">
        <div class="col-lg-12">
          <div class="title-box">
            ...
            <p>Kindly input your email below.</p>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12 col-xs-12">
          ...
          <form method="POST" action="find_email.php">
            <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <input type="email" class="form-control" id="email" name="email" placeholder="Your Email..." required data-error="Please enter your Email Address...">
